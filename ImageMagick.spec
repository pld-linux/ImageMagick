...
Summary(pl.UTF-8):	Moduł kodera dla plików Postscript używający rozszerzenia DPS
Group:		X11/Applications/Graphics
Requires:	%{name} = %{epoch}:%{version}-%{release}
...
%description coder-dps -l pl.UTF-8
Moduł kodera dla plików Postscript używający rozszerzenia DPS (Display
PostScript).
